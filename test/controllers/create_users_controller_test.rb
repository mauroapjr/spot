...
class CreateUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create create_user" do
    assert_difference('CreateUser.count') do
      post create_users_url, params: { create_user: { email: @create_user.email, name: @create_user.name, password_digest: @create_user.password_digest } }
    end
  ...
  test "should update create_user" do
    patch create_user_url(@create_user), params: { create_user: { email: @create_user.email, name: @create_user.name, password_digest: @create_user.password_digest } }
